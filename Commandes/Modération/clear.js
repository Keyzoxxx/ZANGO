...
module.exports = new Command({
    ...
    async run(bot, message, args) {
        ...
        try {
            ...
            .setColor(bot.color)
            .setDescription(`<:error:1008597496785805353> Les messages datent de plus de 14 jours !`)
            ...
            message.channel.bulkDelete(number).catch(async err => {
                ...
                try {
                    ...
                    .setColor(bot.color)
                    .setDescription(`<:success:1008597626154926141> ${message.author === undefined ? message.user : message.author} a supprimé \`${msg.size}\` messages avec succès !`)
