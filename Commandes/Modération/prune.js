...
module.exports = new Command({
    ...
    async run(bot, message, args) {
        ...
        try {
            ...
            .setColor(bot.color)
            .setDescription(`<:error:1008597496785805353> Veuillez indiquer un nombre entre \`0\` et \`100\` !`)
            ...
            try {
                ...
                .setColor(bot.color)
                .setDescription(`<:error:1008597496785805353> \`${user.tag}\` n'a envoyé aucun message dans ce salon !`)
                ...
                .setColor(bot.color)
                .setDescription(`<:success:1008597626154926141> ${message.author === undefined ? message.user : message.author} a supprimé \`${msg.size}\` messages de \`${user.tag}\` avec succès !`)
                ...
                .setColor(bot.color)
                .setDescription(`<:error:1008597496785805353> \`${user.tag}\` n'a envoyé aucun message dans ce salon les 14 derniers jours !`)
                ...
                .setColor(bot.color)
                .setDescription(`<:success:1008597626154926141> ${message.author === undefined ? message.user : message.author} a supprimé \`${msg.size}\` messages de \`${user.tag}\` car les autres dataient de plus de 14 jours avec succès !`)
